...
def cutting_session(slaydict, output_file, 
    ...
    have the following format:
        ...
        slaydict = {hight: ['slayfile.fits',Flip_boolean,[skip_radii]]},
    ...
    #                    drunkdict[z][2]]
    print "minimizing..."
    pf = spo.fmin(solo,p0,args=(slaydict,name,f,size,pars,fixed,flare))
