...
pro ma_dfk_models, output, dispdata, Z, plot=plot
...
ma_vdisp = AA_vdisp/m.wave*3e5 ;resolution in km/s
...
for zz = 0, numZ - 1 do begin
   ...
   for ff = 0, 4 do begin
      for gg = 0, numdfk - 1 do begin
         ...
         print, n_elements(vdisp_vec[*,ff]), n_elements(ma_vdisp)
         vdisp_add = sqrt(vdisp_vec[*,ff]^2 - ma_vdisp^2)  
