...
outputarray = {TAUV: 0.0D, TAUV_ERR: 0.0D, LIGHT_FRAC: dblarr(10),$
               ...
               MMWA: 0.0D, MLWA: 0.0D, SNR: 0.0D, final_norm: dblarr(10)}
...
;mwrfits, s, 'NGC_test.fits', /create
   ...
   printf, lun, i+1, coef.light_frac/final_norm, coef.Z, coef.MMWA, coef.MLWA,$
           ceof.tauv, coef.SNR, coef.chisq, coef.redchi, coef.bluechi, coef.hkchi,$
           format=fmt
